...
//         const unSuspendLevelsIds = levelsIds.filter(
//           (levelId) => !unit.suspendedLevelsIds.includes(levelId)
//         );
//         console.log(
//           'repo - getsLevelsByUnitId: unSuspendLevelsIds',
//           unit.suspendedLevelsIds,
//           unSuspendLevelsIds
//         );
//         if (unSuspendLevelsIds.length > 0) {
//           const levelsDetails = await LevelsModel.find({
//             _id: { $in: unSuspendLevelsIds },
//           });
//           console.log(
//             'units repo - getsLevelsByUnitId unit, levelsId, levelsDetails',
//             unit,
//             levelsIds,
//             levelsDetails
//           );
...
//           console.log(
//             'courses repo getUnitsById - levelsInOrder',
//             levelsInOrder
//           );
...
//         const levelsIds = unit.levelsIds;
//         console.log(
//           'repo - getUnsuspendedUnitsByCourseId: levelsIds',
//           levelsIds
//         );
//         const unSuspendLevelsIds = levelsIds.filter(
//           (levelId) => !unit.suspendedLevelsIds.includes(levelId)
//         );
//         console.log(
//           'repo - getUnsuspendedLevelsByUnitId: unSuspendLevelsIds',
//           unit.suspendedLevelsIds,
//           unSuspendLevelsIds
//         );
//         if (unSuspendLevelsIds.length > 0) {
...
//           if (
//             prevLevelIdIndex !== -1 &&
//             prevLevelIdIndex + 1 !== levelsIds.length
//           ) {
